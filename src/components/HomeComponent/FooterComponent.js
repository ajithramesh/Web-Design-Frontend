    ...
    <MDBFooter style={{backgroundColor: "black"}} className="font-small pt-4 mt-4">
      <MDBContainer fluid className="text-left text-md-left" style={{color: "white"}} >
        <MDBRow>
          <MDBCol md="4">
            ...
            FlixFarm is the world's leading streaming entertainment service with over 167 million paid memberships in over 190 countries feature films across a wide variety of genres and languages. 
            </p>
          </MDBCol>
          ...
          <MDBCol md="3" className='ml-2'>
            ...
            <div>
              ...
              <a href="mailto:vmande94@gmail.com, abajithramesh13@gmail.com, abhiwase1995@gmail.com" target = "gmail.com">flixfarm@gmail.com</a>
      ...
      <div className="footer-copyright text-center py-3">
        <MDBContainer fluid style={{color: "white"}}>
          &copy; {new Date().getFullYear()} Copyright: <a href="https://www.netflix.com/"> FlixFarm.com </a>
        </MDBContainer>
      </div>
    </MDBFooter>
  );
